...
function leiaMais1() {
    ...
    if (tresPontos1.style.display === 'none') {
        ...
        btnLeiaMais1.innerHTML = 'Soco sério';
    } else {
...
function leiaMais2() {
  ...
  if (tresPontos2.style.display === 'none') {
      ...
      btnLeiaMais2.innerHTML = 'Soco super sério';
  } else {
...
function leiaMais3() {
  ...
  if (tresPontos3.style.display === 'none') {
      ...
      btnLeiaMais3.innerHTML = 'Sério mortalmente sério soco sério super sério';
  } else {
...
function leiaMais4() {
  ...
  if (tresPontos4.style.display === 'none') {
      ...
      btnLeiaMais4.innerHTML = 'saltos consecutivos laterais sérios';
  } else {
...
function leiaMais5() {
  ...
  if (tresPontos5.style.display === 'none') {
      ...
      btnLeiaMais5.innerHTML = 'Saitai adventure';
  } else {
...
function leiaMais6() {
  ...
  if (tresPontos6.style.display === 'none') {
      ...
      btnLeiaMais6.innerHTML = 'heaven break';
  } else {
...
function leiaMais7() {
  ...
  if (tresPontos7.style.display === 'none') {
      ...
      btnLeiaMais7.innerHTML = 'Invocação: Squirtle';
  } else {
...
function leiaMais8() {
  ...
  if (tresPontos8.style.display === 'none') {
      ...
      btnLeiaMais8.innerHTML = 'Invocação: Dragão branco de olhos azuis jr';
  } else {
