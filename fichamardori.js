...
function leiaMais1() {
    ...
    if (tresPontos1.style.display === 'none') {
        ...
        btnLeiaMais1.innerHTML = 'Domínio dos mortos';
    } else {
...
function leiaMais2() {
  ...
  if (tresPontos2.style.display === 'none') {
      ...
      btnLeiaMais2.innerHTML = 'Golpe de misericórdia';
  } else {
...
function leiaMais3() {
  ...
  if (tresPontos3.style.display === 'none') {
      ...
      btnLeiaMais3.innerHTML = 'Assombração';
  } else {
...
function leiaMais4() {
  ...
  if (tresPontos4.style.display === 'none') {
      ...
      btnLeiaMais4.innerHTML = 'Quoth e Roäc';
  } else {
...
function leiaMais5() {
  ...
  if (tresPontos5.style.display === 'none') {
      ...
      btnLeiaMais5.innerHTML = 'Sussurros';
  } else {
...
function leiaMais6() {
  ...
  if (tresPontos6.style.display === 'none') {
      ...
      btnLeiaMais6.innerHTML = 'Pressão espiritual';
  } else {
...
function leiaMais7() {
  ...
  if (tresPontos7.style.display === 'none') {
      ...
      btnLeiaMais7.innerHTML = 'Toque arrepiante';
  } else {
...
function leiaMais8() {
  ...
  if (tresPontos8.style.display === 'none') {
      ...
      btnLeiaMais8.innerHTML = 'Passo relâmpago (Básico)';
  } else {
...
function leiaMais9() {
  ...
  if (tresPontos9.style.display === 'none') {
      ...
      btnLeiaMais9.innerHTML = 'Sequelas';
  } else {
...
function leiaMais10() {
  ...
  if (tresPontos10.style.display === 'none') {
      ...
      btnLeiaMais10.innerHTML = 'Espirítio vingativo';
  } else {
...
function leiaMais11() {
  ...
  if (tresPontos11.style.display === 'none') {
      ...
      btnLeiaMais11.innerHTML = 'Armadura espectral';
  } else {
...
function leiaMais12() {
  ...
  if (tresPontos12.style.display === 'none') {
      ...
      btnLeiaMais12.innerHTML = 'Crepúsculo';
  } else {
...
function leiaMais13() {
  ...
  if (tresPontos13.style.display === 'none') {
      ...
      btnLeiaMais13.innerHTML = 'Spectre Noctes Insones';
  } else {
...
function leiaMais14() {
  ...
  if (tresPontos14.style.display === 'none') {
      ...
      btnLeiaMais14.innerHTML = 'Volo spectris';
  } else {
...
function leiaMais15() {
  ...
  if (tresPontos15.style.display === 'none') {
      ...
      btnLeiaMais15.innerHTML = 'Spiritus Geminae';
  } else {
...
function leiaMais16() {
  ...
  if (tresPontos16.style.display === 'none') {
      ...
      btnLeiaMais16.innerHTML = 'Odio Sponsae';
  } else {
...
function leiaMais1a() {
  ...
  if (tresPontos1a.style.display === 'none') {
      ...
      btnLeiaMais1a.innerHTML = 'Noivo do ódio';
  } else {
