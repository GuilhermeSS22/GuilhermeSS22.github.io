...
function leiaMais2() {
  ...
  if (tresPontos2.style.display === 'none') {
      ...
      btnLeiaMais2.innerHTML = 'Manipulação de mana';
  } else {
...
function leiaMais3() {
  ...
  if (tresPontos3.style.display === 'none') {
      ...
      btnLeiaMais3.innerHTML = 'Coração das cartas';
  } else {
...
function leiaMais1a() {
  ...
  if (tresPontos1a.style.display === 'none') {
      ...
      btnLeiaMais1a.innerHTML = 'Instinto dracônico';
  } else {
