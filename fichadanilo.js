...
function leiaMais1() {
    ...
    if (tresPontos1.style.display === 'none') {
        ...
        btnLeiaMais1.innerHTML = 'Telepatia';
    } else {
...
function leiaMais2() {
  ...
  if (tresPontos2.style.display === 'none') {
      ...
      btnLeiaMais2.innerHTML = 'Transferir';
  } else {
...
function leiaMais3() {
  ...
  if (tresPontos3.style.display === 'none') {
      ...
      btnLeiaMais3.innerHTML = 'Seja criativo';
  } else {
...
function leiaMais4() {
  ...
  if (tresPontos4.style.display === 'none') {
      ...
      btnLeiaMais4.innerHTML = 'Conceder';
  } else {
...
function leiaMais6() {
  ...
  if (tresPontos6.style.display === 'none') {
      ...
      btnLeiaMais6.innerHTML = 'Conversão de vida(Lp)';
  } else {
...
function leiaMais7() {
  ...
  if (tresPontos7.style.display === 'none') {
      ...
      btnLeiaMais7.innerHTML = 'Olho perspicaz';
  } else {
...
function leiaMais8() {
  ...
  if (tresPontos8.style.display === 'none') {
      ...
      btnLeiaMais8.innerHTML = 'Avaliar';
  } else {
...
function leiaMais9() {
  ...
  if (tresPontos9.style.display === 'none') {
      ...
      btnLeiaMais9.innerHTML = 'Passo furtivo';
  } else {
...
function leiaMais10() {
  ...
  if (tresPontos10.style.display === 'none') {
      ...
      btnLeiaMais10.innerHTML = 'Peitos grandes';
  } else {
...
function leiaMais11() {
  ...
  if (tresPontos11.style.display === 'none') {
      ...
      btnLeiaMais11.innerHTML = 'Bala de pedra';
  } else {
...
function leiaMais12() {
  ...
  if (tresPontos12.style.display === 'none') {
      ...
      btnLeiaMais12.innerHTML = 'Invocação';
  } else {
...
function leiaMais13() {
  ...
  if (tresPontos13.style.display === 'none') {
      ...
      btnLeiaMais13.innerHTML = 'Dimensão de bolso';
  } else {
